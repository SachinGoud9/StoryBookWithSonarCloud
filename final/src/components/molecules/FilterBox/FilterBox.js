...
*/
 ...
 function StyledCheckbox(props) {
	const onlyCheckBox = useStylesForOnlyCheckBox();
  
	return (
	  <checkBox
		className={onlyCheckBox.root}
		
		disableRipple
		color="default"
		checkedIcon={<span className={clsx(onlyCheckBox.icon, onlyCheckBox.checkedIcon)} />}
		icon={<span className={onlyCheckBox.icon} />}
